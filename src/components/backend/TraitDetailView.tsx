...
export const TraitDetailView: React.FC<TraitDetailViewProps> = ({ dataset, onSaveDataset }) => {
  ...
  return (
    <div id="trait-detail-view" className="flex flex-col md:flex-row gap-5">
      {/* Left List of Traits */}
      <div className="w-full md:w-1/3 border-2 border-black p-3 bg-white max-h-[860px] overflow-y-auto flex flex-col gap-3">
      ...
      <div id="trait-editor-panel" className="w-full md:w-2/3 border-2 border-black p-5 bg-white flex flex-col gap-5 min-h-[640px]">
